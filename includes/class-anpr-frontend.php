			...
			array(
				...
				'i18n'      => array(
					...
					'player'     => array(
						...
						/* translators: %s: take number */
						'takeDone'       => __( 'Take %s saved in this page. Press Play to hear it with the music.', 'ars-nova-practice' ),
						/* translators: %s: take number */
						...
						'correctionHelp' => __( 'If your takes sound late against the music, move this to the right before recording again.', 'ars-nova-practice' ),
						/* translators: %s: milliseconds */
						'latency'        => __( 'measured delay %s ms', 'ars-nova-practice' ),
						'deleteTake'     => __( 'Delete the selected take', 'ars-nova-practice' ),
						'deleteHint'     => __( 'Click a take to select it, then delete it to try again.', 'ars-nova-practice' ),
						'download'       => __( 'Download the selected take (.wav)', 'ars-nova-practice' ),
						...
						'notSaved'       => __( 'Takes stay in this page and are not uploaded. Download one to keep it.', 'ars-nova-practice' ),
					),
				),
			)
		);
