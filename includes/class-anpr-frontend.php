			...
			array(
				...
				'i18n'      => array(
					...
					'player'     => array(
						...
						'restart'     => __( 'Back to start', 'ars-nova-practice' ),
						'loading'     => __( 'Loading the tracks…', 'ars-nova-practice' ),
						'ready'       => __( 'Ready', 'ars-nova-practice' ),
						'mute'        => __( 'Mute', 'ars-nova-practice' ),
						'unmute'      => __( 'Unmute', 'ars-nova-practice' ),
						'volume'      => __( 'Volume', 'ars-nova-practice' ),
						'ear'         => __( 'Ear', 'ars-nova-practice' ),
